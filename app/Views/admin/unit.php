<div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-floating">
                    <input id="name" class="form-control" placeholder="Unité de mesure" type="text" name="name" required>
                    <label for="name">Unité de mesure</label>
                </div>
            </div>
            <div class="card-footer text-end">
                <button type="submit" class="btn btn-primary"><i class="fas fa-plus"></i> Ajouter l'unité de mesure</button>
            </div>
            <?= form_close() ?>
        </div>
    </div>
    <div class="col-md-9">
        <div class="card">
            ...
            <div class="card-body">
                <table id="unitsTable" class="table table-sm table-hover">
                    <thead>
                    <tr>
                        <th>ID</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Éditer l'unité de mesure</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="form-floating">
                    <input type="text" class="form-control" id="modalNameInput" placeholder="Unité de mesure" data-id="">
                    <label for="modalNameInput">Unité de mesure</label>
                </div>
            </div>
...
<script>
                    ...
                    render: function(data, type, row) {
                        return `
                            <div class="btn-group" role="group">
                                <button onclick="showModal(${row.id},'${row.name.replace(/'/g, "\\'")}')"  class="btn btn-sm btn-warning" title="Modifier">
    ...
    function deleteUnit(id){
        Swal.fire({
            title: `Êtes-vous sûr ?`,
            text: `Voulez-vous vraiment supprimer cette unité de mesure ?`,
            icon: "warning",
